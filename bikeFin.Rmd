...
데이터 Import
```{r}
  setwd("/Users/jimmybae/Downloads/Bike_Share_Membership/trip_data")
...
작업 디렉토리 상위폴더로 변경
```{r}
setwd("/Users/jimmybae/Downloads/Bike_Share_Membership")
...
```{r}
write.csv(all_trips3_2, file = '/Users/jimmybae/Downloads/Bike_Share_Membership/all_trips4.csv')
```
...
##```{r}
##write.csv(ratio_length_data2, file = ##'/Users/jimmybae/Downloads/Bike_Share_Membership/ratio_length_data2.csv')
##```
계산
